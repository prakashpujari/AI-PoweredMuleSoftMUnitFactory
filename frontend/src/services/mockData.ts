/**
 * Demo data for screenshot / offline mode.
 * Used when VITE_DEMO_MODE=true or API is unavailable.
 */
import type { DashboardData, ExecutiveReport, Application } from "../types";
