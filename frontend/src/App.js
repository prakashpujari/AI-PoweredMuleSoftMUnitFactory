...
import { Dashboard as DashboardIcon, Apps, Assessment, } from "@mui/icons-material";
...
const Sidebar = () => {
    ...
    return (_jsxs(Drawer, { variant: "permanent", sx: {
            ...
            "& .MuiDrawer-paper": {
                ...
                }) }), _jsx(Box, { sx: { flexGrow: 1 } }), _jsx(Box, { sx: { p: 2 }, children: _jsx(Chip, { label: "v1.0.0", size: "small", sx: { bgcolor: "rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.8)" } }) })] }));
};
const App = () => {
    return (_jsxs(ThemeProvider, { theme: theme, children: [_jsx(CssBaseline, {}), _jsx(BrowserRouter, { children: _jsxs(Box, { sx: { display: "flex", minHeight: "100vh" }, children: [_jsx(Sidebar, {}), _jsx(Box, { component: "main", sx: { flexGrow: 1, bgcolor: "background.default", overflow: "auto" }, children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/applications", element: _jsx(Applications, {}) }), _jsx(Route, { path: "/executive-report", element: _jsx(ExecutiveReport, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/" }) })] }) })] }) })] }));
};
export default App;
